...
static void rightTurnBox(OverlayRendererControl *controller)
{
	...
	float turnrad = (90 - controller->turn_angle) * ((2*pi)/360);
	...
	controller->square[0][1] = (int) ((controller->x3 - controller->square[0][0]) * sin(turnrad) + (controller->y3 - controller->square[0][1]) * cos(turnrad) + controller->y3);
	...
	controller->square[1][1] = (int) ((controller->x3 - controller->square[1][0]) * sin(turnrad) + (controller->y3 - controller->square[1][1]) * cos(turnrad) + controller->y3);
	...
	controller->square[2][1] = (int) ((controller->x3 - controller->square[2][0]) * sin(turnrad) + (controller->y3 - controller->square[2][1]) * cos(turnrad) + controller->y3);
	...
	controller->square[3][1] = (int) ((controller->x3 - controller->square[3][0]) * sin(turnrad) + (controller->y3 - controller->square[3][1]) * cos(turnrad) + controller->y3);
	...
	controller->triangle[0][1] = (int) ((controller->x3 - controller->triangle[0][0]) * sin(turnrad) + (controller->y3 - controller->triangle[0][1]) * cos(turnrad) + controller->y3);
	...
	controller->triangle[1][1] = (int) ((controller->x3 - controller->triangle[1][0]) * sin(turnrad) + (controller->y3 - controller->triangle[1][1]) * cos(turnrad) + controller->y3);
	...
	controller->triangle[2][1] = (int) ((controller->x3 - controller->triangle[2][0]) * sin(turnrad) + (controller->y3 - controller->triangle[2][1]) * cos(turnrad) + controller->y3);
}
